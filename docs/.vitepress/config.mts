...
export default defineConfig({
	...
	head: [
		...
		["meta", { name: "keywords", content: "Veha0001, VitePress, Documentation, Web Development, Khmer" }],
		["meta", { name: "description", content: "Veha0001's VitePress site for documentation and examples." }],
	],
	themeConfig: {
		logo: "/favicon.ico",
